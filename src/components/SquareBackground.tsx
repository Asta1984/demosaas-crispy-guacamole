...
export default function Spacetimefabric() {
  return (
    <div>
    <div className="relative -mb-40 p-16 ">
      <div className="relative h-screen rounded-3xl">
        ...
        <div className="absolute inset-0 flex justify-center">
          ...
          <CardContent className="flex flex-col gap-2 p-6 md:p-20">
            <CardTitle className='text-primary font-OnlinePrivileges text-2xl md:text-4xl'>Exceptional solutions that matters.</CardTitle>
